    ...
    <div className="main">
      ...
      <div className="wrapper-product">
        <div className="wrapper-sroll">
          <Container fluid className="container-load">
            <Row>
              {productList &&
      ...
      <div className="main-bottom">
        ...
        <img className="videoObject1" src={videoObject3} alt="videoObject1" />

        <img className="videoObject3" src={videoObject1} alt="videoObject1" />
